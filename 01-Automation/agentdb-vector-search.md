...
quality: 10
categories: [automation, dev, ai-agent, design, data, research]
source-repo: installed
source-path: /home/sprit/.claude/skills/agentdb-vector-search/SKILL.md
dup-count: 1
...
**Invocation:** Drop this folder into `~/.claude/skills/agentdb-vector-search/` to use in Claude Code, or reference via `[[agentdb-vector-search]]` from other vault notes.
