...
quality: 10
categories: [automation, dev, design, data, security]
source-repo: antigravity-awesome-skills
source-path: /home/sprit/repos-cloned/antigravity-awesome-skills/skills/active-directory-attacks/SKILL.md
dup-count: 3
...
---
**Provenance:** Originally from [`antigravity-awesome-skills`](). Cross-referenced in 3 bundle(s): antigravity-awesome-skills.

**Invocation:** Drop this folder into `~/.claude/skills/active-directory-attacks/` to use in Claude Code, or reference via `[[active-directory-attacks]]` from other vault notes.
