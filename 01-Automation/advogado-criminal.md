...
quality: 10
categories: [automation, design, productivity]
source-repo: antigravity-awesome-skills
source-path: /home/sprit/repos-cloned/antigravity-awesome-skills/skills/advogado-criminal/SKILL.md
dup-count: 4
...
**Invocation:** Drop this folder into `~/.claude/skills/advogado-criminal/` to use in Claude Code, or reference via `[[advogado-criminal]]` from other vault notes.
