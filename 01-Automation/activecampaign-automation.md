...
quality: 10
categories: [automation, marketing, dev, ai-agent, design, productivity, research]
source-repo: antigravity-awesome-skills
source-path: /home/sprit/repos-cloned/antigravity-awesome-skills/skills/activecampaign-automation/SKILL.md
dup-count: 4
tags: [skill, suprapack, automation]
---

# activecampaign-automation

> SupraPack v1 · Quality: 10/10 · Source: `antigravity-awesome-skills`
> Categories: automation, marketing, dev, ai-agent, design, productivity, research
...
---
**Provenance:** Originally from [`antigravity-awesome-skills`](). Cross-referenced in 4 bundle(s): antigravity-awesome-skills, installed.

**Invocation:** Drop this folder into `~/.claude/skills/activecampaign-automation/` to use in Claude Code, or reference via `[[activecampaign-automation]]` from other vault notes.
