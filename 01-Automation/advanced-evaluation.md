...
quality: 10
categories: [automation, finance, dev, design, research]
source-repo: antigravity-awesome-skills
source-path: /home/sprit/repos-cloned/antigravity-awesome-skills/skills/advanced-evaluation/SKILL.md
dup-count: 4
...
**Invocation:** Drop this folder into `~/.claude/skills/advanced-evaluation/` to use in Claude Code, or reference via `[[advanced-evaluation]]` from other vault notes.
