...
slug: agentdb-performance-optimization
description: Optimize AgentDB performance with quantization (4-32x memory reduction), HNSW indexing (150x faster search), caching, and batch operations. Use when optimizing memory usage, improving search speed, or
quality: 10
categories: [dev, ai-agent, design, data, research]
source-repo: installed
source-path: /home/sprit/.claude/skills/agentdb-optimization/SKILL.md
dup-count: 1
tags: [skill, suprapack, dev]
---

# AgentDB Performance Optimization

> SupraPack v1 · Quality: 10/10 · Source: `installed`
> Categories: dev, ai-agent, design, data, research
...
---
**Provenance:** Originally from [`installed`](). Cross-referenced in 1 bundle(s): installed.

**Invocation:** Drop this folder into `~/.claude/skills/agentdb-performance-optimization/` to use in Claude Code, or reference via `[[agentdb-performance-optimization]]` from other vault notes.
