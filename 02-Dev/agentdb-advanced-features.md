...
slug: agentdb-advanced-features
...
source-path: /home/sprit/.claude/skills/agentdb-advanced/SKILL.md
dup-count: 1
...
**Invocation:** Drop this folder into `~/.claude/skills/agentdb-advanced-features/` to use in Claude Code, or reference via `[[agentdb-advanced-features]]` from other vault notes.
