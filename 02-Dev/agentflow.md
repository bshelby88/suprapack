...
quality: 10
categories: [dev, ai-agent, design, data, productivity, research]
source-repo: antigravity-awesome-skills
source-path: /home/sprit/repos-cloned/antigravity-awesome-skills/skills/agentflow/SKILL.md
dup-count: 3
...
---
**Provenance:** Originally from [`antigravity-awesome-skills`](). Cross-referenced in 3 bundle(s): antigravity-awesome-skills, installed.

**Invocation:** Drop this folder into `~/.claude/skills/agentflow/` to use in Claude Code, or reference via `[[agentflow]]` from other vault notes.
