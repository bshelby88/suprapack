...
slug: agentdb-learning-plugins
description: Create and train AI learning plugins with AgentDB's 9 reinforcement learning algorithms. Includes Decision Transformer, Q-Learning, SARSA, Actor-Critic, and more. Use when building self-learning agent
quality: 10
categories: [dev, ai-agent, design]
source-repo: installed
source-path: /home/sprit/.claude/skills/agentdb-learning/SKILL.md
dup-count: 1
...
**Invocation:** Drop this folder into `~/.claude/skills/agentdb-learning-plugins/` to use in Claude Code, or reference via `[[agentdb-learning-plugins]]` from other vault notes.
