...
description: Implement persistent memory patterns for AI agents using AgentDB. Includes session memory, long-term storage, pattern learning, and context management. Use when building stateful agents, chat systems,
quality: 10
categories: [dev, ai-agent, design, data]
source-repo: installed
source-path: /home/sprit/.claude/skills/agentdb-memory-patterns/SKILL.md
dup-count: 1
...
**Invocation:** Drop this folder into `~/.claude/skills/agentdb-memory-patterns/` to use in Claude Code, or reference via `[[agentdb-memory-patterns]]` from other vault notes.
