...
quality: 10
categories: [marketing, dev, data]
source-repo: antigravity-awesome-skills
source-path: /home/sprit/repos-cloned/antigravity-awesome-skills/skills/ai-md/SKILL.md
dup-count: 3
...
**Invocation:** Drop this folder into `~/.claude/skills/ai-md/` to use in Claude Code, or reference via `[[ai-md]]` from other vault notes.
