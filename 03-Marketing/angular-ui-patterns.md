...
quality: 10
categories: [marketing, dev, design, data]
source-repo: antigravity-awesome-skills
source-path: /home/sprit/repos-cloned/antigravity-awesome-skills/skills/angular-ui-patterns/SKILL.md
dup-count: 4
...
**Invocation:** Drop this folder into `~/.claude/skills/angular-ui-patterns/` to use in Claude Code, or reference via `[[angular-ui-patterns]]` from other vault notes.
