...
quality: 10
categories: [marketing, finance, dev, ai-agent, design, security, productivity]
source-repo: antigravity-awesome-skills
source-path: /home/sprit/repos-cloned/antigravity-awesome-skills/skills/007/SKILL.md
dup-count: 4
...
**Invocation:** Drop this folder into `~/.claude/skills/007/` to use in Claude Code, or reference via `[[007]]` from other vault notes.
