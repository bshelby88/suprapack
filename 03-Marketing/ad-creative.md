...
quality: 10
categories: [marketing, dev, ai-agent, design, data, productivity, research, writing]
source-repo: antigravity-awesome-skills
source-path: /home/sprit/repos-cloned/antigravity-awesome-skills/skills/ad-creative/SKILL.md
dup-count: 4
tags: [skill, suprapack, marketing]
---
...
**Invocation:** Drop this folder into `~/.claude/skills/ad-creative/` to use in Claude Code, or reference via `[[ad-creative]]` from other vault notes.
